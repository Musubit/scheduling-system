...
func SeedData() {
	...
	teachers := []models.Teacher{
		{Code: "T001", Name: "张建国", Dept: "机械工程学院", Title: "教授", Status: "active"},
		{Code: "T002", Name: "李明远", Dept: "电气与电子工程学院", Title: "教授", Status: "active"},
		{Code: "T003", Name: "王伟", Dept: "材料与化学工程学院", Title: "副教授", Status: "active"},
		{Code: "T004", Name: "刘芳", Dept: "外国语学院", Title: "讲师", Status: "active"},
		{Code: "T005", Name: "赵秀英", Dept: "理学院", Title: "副教授", Status: "active"},
		{Code: "T006", Name: "孙志强", Dept: "经济与管理学院", Title: "教授", Status: "active"},
		{Code: "T007", Name: "周海", Dept: "计算机学院", Title: "副教授", Status: "active"},
		{Code: "T008", Name: "钱学林", Dept: "生物工程与食品学院", Title: "教授", Status: "active"},
		{Code: "T009", Name: "吴芳", Dept: "马克思主义学院", Title: "讲师", Status: "active"},
		{Code: "T010", Name: "郑美", Dept: "艺术设计学院", Title: "副教授", Status: "active"},
		{Code: "T011", Name: "陈刚", Dept: "体育学院", Title: "讲师", Status: "active"},
		{Code: "T012", Name: "杨华", Dept: "土木建筑与环境学院", Title: "教授", Status: "active"},
		{Code: "T013", Name: "黄蕾", Dept: "工业设计学院", Title: "副教授", Status: "active"},
	}
	DB.Create(&teachers)
	...
	courses := []models.Course{
		{Code: "ME201", Name: "机械设计基础", Dept: "mech", Credit: 4.0, Type: "专业必修", Hours: 64},
		{Code: "ME301", Name: "数控技术", Dept: "mech", Credit: 3.0, Type: "专业必修", Hours: 48},
		{Code: "EE201", Name: "电路原理", Dept: "elec", Credit: 4.0, Type: "专业必修", Hours: 64},
		{Code: "EE301", Name: "电力系统分析", Dept: "elec", Credit: 3.0, Type: "专业必修", Hours: 48},
		{Code: "MC201", Name: "有机化学", Dept: "mate", Credit: 4.0, Type: "专业必修", Hours: 64},
		{Code: "BF201", Name: "生物化学", Dept: "bio", Credit: 4.0, Type: "专业必修", Hours: 64},
		{Code: "CE201", Name: "结构力学", Dept: "civil", Credit: 4.0, Type: "专业必修", Hours: 64},
		{Code: "CE301", Name: "工程制图", Dept: "civil", Credit: 3.0, Type: "专业必修", Hours: 48},
		{Code: "CS301", Name: "数据结构", Dept: "cs", Credit: 4.0, Type: "专业必修", Hours: 64},
		{Code: "CS302", Name: "操作系统", Dept: "cs", Credit: 4.0, Type: "专业必修", Hours: 64},
		{Code: "CS303", Name: "计算机网络", Dept: "cs", Credit: 3.0, Type: "专业必修", Hours: 48},
		{Code: "AD201", Name: "设计素描", Dept: "art", Credit: 3.0, Type: "专业必修", Hours: 48},
		{Code: "ID201", Name: "产品设计", Dept: "design", Credit: 3.0, Type: "专业必修", Hours: 48},
		{Code: "EM201", Name: "西方经济学", Dept: "econ", Credit: 3.0, Type: "专业必修", Hours: 48},
		{Code: "EM202", Name: "财务管理", Dept: "econ", Credit: 3.0, Type: "专业必修", Hours: 48},
		{Code: "EN101", Name: "大学英语", Dept: "eng", Credit: 3.0, Type: "公共必修", Hours: 48},
		{Code: "EN102", Name: "英语听说", Dept: "eng", Credit: 2.0, Type: "公共必修", Hours: 32},
		{Code: "SC201", Name: "高等数学", Dept: "sci", Credit: 5.0, Type: "公共必修", Hours: 80},
		{Code: "SC202", Name: "线性代数", Dept: "sci", Credit: 3.0, Type: "公共必修", Hours: 48},
		{Code: "SC203", Name: "大学物理", Dept: "sci", Credit: 4.0, Type: "公共必修", Hours: 64},
		{Code: "MX101", Name: "马克思主义基本原理", Dept: "marx", Credit: 2.0, Type: "公共必修", Hours: 32},
		{Code: "MX102", Name: "形势与政策", Dept: "marx", Credit: 1.0, Type: "公共必修", Hours: 16},
		{Code: "PE101", Name: "体育(篮球)", Dept: "pe", Credit: 1.0, Type: "公共必修", Hours: 32},
	}
	DB.Create(&courses)

	// ===== Class Groups =====
	groups := []models.ClassGroup{
		{Code: "CS2301", Name: "计算机2301", Dept: "计算机学院", Grade: 2023, Students: 86},
		{Code: "CS2302", Name: "计算机2302", Dept: "计算机学院", Grade: 2023, Students: 82},
		{Code: "ME2301", Name: "机械2301", Dept: "机械工程学院", Grade: 2023, Students: 72},
		{Code: "EE2301", Name: "电气2301", Dept: "电气与电子工程学院", Grade: 2023, Students: 68},
		{Code: "CE2301", Name: "土木2301", Dept: "土木建筑与环境学院", Grade: 2023, Students: 55},
		{Code: "EM2301", Name: "经管2301", Dept: "经济与管理学院", Grade: 2023, Students: 78},
		{Code: "AD2301", Name: "艺设2301", Dept: "艺术设计学院", Grade: 2023, Students: 40},
	}
	DB.Create(&groups)
