...
export class TeachingTask {
    ...
    static createFrom($$source = {}) {
        ...
        if ("teacher" in $$parsedSource) {
            $$parsedSource["teacher"] = $$createField9_0($$parsedSource["teacher"]);
        }
        if ("semester" in $$parsedSource) {
            $$parsedSource["semester"] = $$createField10_0($$parsedSource["semester"]);
        }
        if ("classes" in $$parsedSource) {
            $$parsedSource["classes"] = $$createField11_0($$parsedSource["classes"]);
        }
