...
export function AnalyzeTeacherWorkload(semesterID) {
    return $Call.ByID(2269459629, semesterID).then(/** @type {($result: any) => any} */(($result) => {
 ...
 */
export function CreateManualSnapshot(semesterID) {
    return $Call.ByID(299046732, semesterID).then(/** @type {($result: any) => any} */(($result) => {
 ...
 * @returns {$CancellablePromise<models$0.ScheduleSnapshot | null>}
 */
export function CreateSnapshot(semesterID, dept, trigger, solver, entries, teachers, classrooms, scoringCtx, solveTimeMs, conflictCount) {
    return $Call.ByID(1676786010, semesterID, dept, trigger, solver, entries, teachers, classrooms, scoringCtx, solveTimeMs, conflictCount).then(/** @type {($result: any) => any} */(($result) => {
        return $$createType5($result);
    }));
}
 ...
 */
export function GetSnapshots(semesterID) {
    return $Call.ByID(3410442531, semesterID).then(/** @type {($result: any) => any} */(($result) => {
