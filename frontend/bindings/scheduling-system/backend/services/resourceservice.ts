 ...
 */
export function GetBuildings(): $CancellablePromise<models$0.Building[] | null> {
    return $Call.ByID(2002893851);
}
...
export function GetScheduleEntries(semesterID: number): $CancellablePromise<models$0.ScheduleEntry[] | null> {
    return $Call.ByID(1541252201, semesterID);
}
